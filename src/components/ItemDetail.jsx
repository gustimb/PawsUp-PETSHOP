...
const DetalleProducto = (item) => {
    ...
    const sumarAlCarrito = () => {
        const alertaAgregoACarrito = () => {
            Swal.fire("", `Agregaste ${cantidadItems} items al carrito!`)
        }
        alertaAgregoACarrito()
    ...
    return (
        <div className="contenedorDetalle">
            ...
            <div className="textoDetalle">
                ...
                <p className="txtPDetalle"> Descripción: {item.datos.description}</p>
